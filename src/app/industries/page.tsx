        ...
        <div className="container">
          <StaggerContainer className={styles.grid}>
            ...
            <StaggerItem className={styles.industryCard} id="mobility">
              ...
              <MagneticButton href="/assessment" variant="primary-small">Apply for Mobility Audit</MagneticButton>
            </StaggerItem>
            ...
            <StaggerItem className={styles.industryCard} id="healthcare">
              ...
              <MagneticButton href="/assessment" variant="primary-small">Apply for Healthcare Audit</MagneticButton>
            </StaggerItem>
            ...
            <StaggerItem className={styles.industryCard} id="cybersecurity">
              ...
              <MagneticButton href="/assessment" variant="primary-small">Apply for Cyber Audit</MagneticButton>
            </StaggerItem>
            ...
            <StaggerItem className={styles.industryCard} id="hr">
              ...
              <MagneticButton href="/assessment" variant="primary-small">Apply for HR Audit</MagneticButton>
            </StaggerItem>
            ...
            <StaggerItem className={styles.industryCard} id="customer-service">
              ...
              <MagneticButton href="/assessment" variant="primary-small">Apply for E-Commerce Audit</MagneticButton>
            </StaggerItem>
            ...
            <StaggerItem className={styles.industryCard} id="supply-chain">
              ...
              <MagneticButton href="/assessment" variant="primary-small">Apply for Logistics Audit</MagneticButton>
            </StaggerItem>
            ...
            <StaggerItem className={styles.industryCard} id="advertising">
              ...
              <MagneticButton href="/assessment" variant="primary-small">Apply for AdTech Audit</MagneticButton>
            </StaggerItem>
