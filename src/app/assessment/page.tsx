...
const sectorMap: Record<string, string> = {
  "mobility": "1. Autonomous Mobility & Transport",
  "finance": "2. Finance & Algorithmic Trading",
  "healthcare": "3. Healthcare & Medical AI",
  "cybersecurity": "4. Cybersecurity & IT Operations",
  "professional": "5. Professional Services: Legal & Tax",
  "hr": "6. HR Tech & Human Capital Management",
  "enterprise": "7. Enterprise Operations & Procurement",
  "customer-service": "8. Customer Service & Autonomous E-Commerce",
  "supply-chain": "9. Supply Chain & Logistics",
  "advertising": "10. Advertising & Creative AdTech"
};
...
function AssessmentFormContent() {
  ...
  const { register, handleSubmit, trigger, formState: { errors }, setValue } = useForm<FormValues>({
  ...
  useEffect(() => {
    if (preselectedSector) {
      setValue("sector", preselectedSector);
    }
  }, [preselectedSector, setValue]);
  ...
  const getMailtoLink = () => {
    ...
    const readableSector = sectorMap[submittedData.sector] || submittedData.sector;
          ...
          >
            ...
            <div className={styles.formGroup}>
              ...
              <select {...register("sector")} className={errors.sector ? styles.inputError : ""}>
                ...
                <option value="mobility">1. Autonomous Mobility & Transport</option>
                <option value="finance">2. Finance & Algorithmic Trading</option>
                <option value="healthcare">3. Healthcare & Medical AI</option>
                <option value="cybersecurity">4. Cybersecurity & IT Operations</option>
                <option value="professional">5. Professional Services: Legal & Tax</option>
                <option value="hr">6. HR Tech & Human Capital Management</option>
                <option value="enterprise">7. Enterprise Operations & Procurement</option>
                <option value="customer-service">8. Customer Service & Autonomous E-Commerce</option>
                <option value="supply-chain">9. Supply Chain & Logistics</option>
                <option value="advertising">10. Advertising & Creative AdTech</option>
              </select>
  ...
  return (
    <main>
      ...
      <section className={styles.formSection}>
        <div className="container">
          <Suspense fallback={<div className={styles.calculatingState}><div className={styles.spinner}></div></div>}>
